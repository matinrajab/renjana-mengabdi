        ...
        <section class="breadcrumb-section breadcrumb-bg">
            <div class="container">
                <div class="breadcrumb-text">
                    ...
                    <h1 class="title wow fadeInUp" data-wow-delay="0.1s">partnership</h1>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <div class="col-lg-10 mt-10">
                            <a href="https://wa.me/+6287123456789?text=Halo%20saya%20tertarik%20untuk%20join%20partnership"
                                class="btn btn-primary-fill">Join Our Partnership</a>
                        </div>
                    </div>
                </div>
            </div>
