                ...
                <div class="main-menu d-none d-lg-block">
                  <nav>
                    <ul class="listing" id="navigation">
                      ...
                      <li class="single-list"><a href="contact-us.html" class="single active">Contact</a></li>
                    </ul>
                  </nav>
                </div>
                ...
                <div class="col-xl-2 col-lg-6">
                  <div class="contact-icon-list">
                    ...
                    <div class="contact-content">
                      ...
                      <a class="title" href="javascript:void(0)">Jln. Balai Desa, Desa Manis Dusun IV, Kec. Pulau
                        Rakyat, Kab. Asahan. Sumatera Utara, Indonesia, 21273</a>
                    </div>
                  </div>
                </div>
                <div class="col-xl-2 col-lg-6">
                  <div class="contact-icon-list">
                    ...
                    <div class="contact-content">
                      ...
                      <a class="title" href="javascript:void(0)">0882016162981</a>
                    </div>
                  </div>
                </div>
                <div class="col-xl-2 col-lg-6">
                  <div class="contact-icon-list">
                    ...
                    <div class="contact-content">
                      ...
                      <a class="title" href="javascript:void(0)">renjanamengabdi.id@gmail.com</a>
                    </div>
                  </div>
                </div>
                <div class="col-xl-2 col-lg-6">
                  <div class="contact-icon-list">
                    ...
                    <div class="contact-content">
                      ...
                      <a class="title" href="javascript:void(0)">renjanamengabdi.id</a>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <li class="single-list">
                    <div class="d-flex gap-20 mb-20 align-items-center">
                      ...
                      <div class="project-info">
                        ...
                        <h4 class="project-title"><a href="donation-details.html">18 Best Charity Marketing
                            Champions</a>
                        </h4>
                      </div>
                    </div>
                  ...
                  <li class="single-list">
                    <div class="d-flex gap-20">
                      ...
                      <div class="project-info">
                        ...
                        <h4 class="project-title"><a href="donation-details.html">Charity starts from home. You Can't
                            Even
                            Help,</a></h4>
                      </div>
                    </div>
