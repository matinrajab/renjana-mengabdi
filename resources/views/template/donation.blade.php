      ...
      <div class="container">
        <div class="row gy-24">
          ...
          <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 view-wrapper">
            <div class="single-donate h-calc">
              <div class="donate-img position-relative">
                <a href="donation-details.html"> <img class="w-100" src="assets/images/gallery/donate-6.png" alt="img">
                </a>
                <div class="donate-badge">
                  <p class="subtitle">Food</p>
                </div>
          ...
          <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 view-wrapper">
            <div class="single-donate h-calc">
              <div class="donate-img position-relative">
                <a href="donation-details.html"> <img class="w-100" src="assets/images/gallery/donate-7.png" alt="img">
                </a>
                <div class="donate-badge">
                  <p class="subtitle">Education</p>
                </div>
          ...
          <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 view-wrapper">
            <div class="single-donate h-calc">
              <div class="donate-img position-relative">
                <a href="donation-details.html"> <img class="w-100" src="assets/images/gallery/donate-8.png" alt="img">
                </a>
                <div class="donate-badge">
                  <p class="subtitle">medical</p>
                </div>
