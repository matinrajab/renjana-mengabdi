          ...
          <div class="col-xl-5 col-lg-6 col-md-8 col-sm-10">
            <div class="login-card">
              ...
              <div class="logo mb-40">
                <a href="index.html" class="mb-30 d-block"><img src="assets/images/logo/Logo-charitfix.png"
                    alt="logo"></a>
              </div>
              <!-- Form -->
                ...
                <div class="row">
                  <div class="col-lg-3">
                    <div class="contact-form mb-24">
                      <input class="form-control contact-input text-center" type="text" placeholder="5">
                    </div>
                  </div>
                  <div class="col-lg-3">
                    <div class="contact-form mb-24">
                      <input class="form-control contact-input text-center" type="text" placeholder="0">
                    </div>
                  </div>
                  <div class="col-lg-3">
                    <div class="contact-form mb-24">
                      <input class="form-control contact-input text-center" type="text" placeholder="3">
                    </div>
                  </div>
                  <div class="col-lg-3">
                    <div class="contact-form mb-24">
                      <input class="form-control contact-input text-center" type="text" placeholder="1">
                    </div>
                  </div>
                </div>
