        ...
        <div class="row gy-24">
          ...
          <div class="col-xl-8 col-md-7 col-lg-7">
            <div class="volunteer-info-card">
              ...
              <p class="pera">Let us embrace the spirit of generosity and compassion, knowing that together, we can
                create a brighter future for individuals, communities and the planet Your donation, no matter the
                amount,</p>
              ...
              <p class="pera">However, if you intended to refer to body or organ donation, that is a separate topic.
                ...
                help save or improve the lives of others in need.</p>
            ...
            <div class="education-section">
              ...
              <div class="education-box">
                <p class="pera">However, if you intended to refer to body or organ donation, that is a separate topic.
                  Organ donation involves the voluntary donation of organs or tissues from a living or deceased person
                  to help save or improve the lives of others in need of</p>
                <p class="pera">transplantation. including poverty, education, healthcare, disaster relief,
                  environmental conservation, and more. People can contribute to charities..</p>
                <ul class="key-points">
            ...
            <div class="skill-section">
              ...
              <div class="skill-box">
                <p class="pera">including poverty, education, healthcare, disaster relief, environmental conservation,
                  and more. People can contribute to charities by making financial donations,</p>
                <div class="row gy-24">
                  <div class="col-xl-6">
