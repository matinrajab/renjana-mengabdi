                ...
                <div class="main-menu d-none d-lg-block">
                  <nav>
                    <ul class="listing" id="navigation">
                      ...
                      <li class="single-list"><a href="blog.html" class="single active">Blog</a></li>
                      <li class="single-list">
            ...
            <div class="single-blog">
              ...
              <div class="blog-info">
                <div class="blog-info-title">
                  ...
                  <h4 class="title">Provide food and clean water to children who are malnourished or living in areas
                    withoutaccess to clean drinking water.</h4>
                  <p class="subtitle">As you may know, there are millions of children living in poverty, without access
                    to basic necessities like food,clean water, Food healthcare. Many of these children are also denied
                    the opportunity.,</p>
                  <div class="divider"></div>
                  <p class="subtitle">As you may know, there are millions of children living in poverty, without access
                    to basic necessities like food, clan water, and Big healthcare. Many of these children are also
                    denied the opportunity to receive an education, perpetu ating the cycle of poverty and limiting
                    their potential for a better future</p>
                  <p class="subtitle">We understand that there are many organizations seeking support, and we appreciate
                    your consideration of [Organization Name]. We assure you that your donation will be used wisely and
                    effectively to support the children.</p>
                  <div class="divider"></div>
                  <div class="quote-with-text">
                    ...
                    <h4 class="title">Donating to charity is a great way to make a positive impact on the world and help
                      those in need. There are many different type of charities and causes tosuport, ranging from local.
                    </h4>
                  </div>
                  ...
                  <div class="donation-content">
                    ...
                    <p class="pera">As you may know, there are millions of children living in poverty, without access to
                      basic necessities like food, clea water, and Big healthcare. Many of these children are also
                      denied the opportunity to receive an education, perpetu al the cycle of poverty and limiting their
                      potential for a better future.</p>
                    <ul class="bullet-list">
                      <li class="list">This is a personal decision that requires careful consideration.</li>
                      <li class="list">help save lives, while others may donate their body to medical research or
                        education.</li>
                      <li class="list">it's important to discuss your wishes with your family</li>
                    </ul>
                    <p class="subtitle">There are millions of children living in poverty, without access to basic
                      necessities like food, clean water,and Big he althcare. Many of these children are also denied the
                    ...
                    <div class="single-blog h-calc">
                      ...
                      <div class="blog-info">
                        <div class="blog-info-title">
                          ...
                          <h4 class="title text-capitalize">You can help make a difference in the lives of these
                            children. With your donation.</h4>
                          <p class="subtitle">without access to basic necessities like food,clean water healthcare. Many
                            of these children are also denied the opportunity ,</p>
            ...
            <div class="comment-list">
              ...
              <div class="single-comment">
                ...
                <div class="comment-info">
                  ...
                  <p class="subtitle">I will give you a complete account of the system, and expound on the actual
                    teachings of the great explorer of the truth, it's important to discuss your wishes with your
                    family.</p>
