              ...
              <form action="#">
                <div class="row">
                  <div class="col-lg-12">
                    <div class="contact-form mb-24">
                      ...
                      <input class="form-control contact-input left_default_amount" type="number" min="1" value="50"
                        placeholder="$50">
                    </div>
                  </div>
                  <div class="col-lg-4">
                ...
                <div class="form-group col-12 payment-gateway-wrapper mt-10">
                  <ul class="payment-gateway-list mb-10">
                    <li class="single-gateway-item selected"><img src="assets/images/icon/payment-method1.png"
                        alt="img"></li>
            ...
            <div class="blog-section-two">
              <div class="single-blog h-calc">
                <div class="blog-img position-relative">
                  <a href="blog-details.html"> <img src="assets/images/gallery/gallery-2.png" class="img-fluid w-100"
                      alt="img"> </a>
                  ...
                  <div class="blog-info">
                    <div class="d-flex justify-content-between align-items-center">
                      <div class="blog-info-title">
                        ...
                        <p class="subtitle">We understand that there are many people organization The seeking support
                        </p>
                        <div class="priceListing">
                          <ul class="listing">
                            <li class="listItem">
                              <p class="leftCap font-600">Your Donation</p>
                              <p class="rightCap total_donation_amount font-600">$40</p>
                            </li>
                            <li class="listItem">
