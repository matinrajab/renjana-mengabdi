                                ...
                                <div class="col-xl-2 col-lg-6">
                                    <div class="contact-icon-list">
                                        ...
                                        <div class="contact-content">
                                            ...
                                            <a class="title" href="javascript:void(0)">Jln. Balai Desa, Desa Manis
                                                Dusun IV, Kec. Pulau
                                ...
                                <div class="col-xl-2 col-lg-6">
                                    <div class="contact-icon-list">
                                        ...
                                        <div class="contact-content">
                                            ...
                                            <a class="title"
                                                href="javascript:void(0)">renjanamengabdi.id@gmail.com</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-2 col-lg-6">
                    ...
                    <div class="row gy-24">
                        ...
                        <div class="col-xl-6">
                            <iframe class="map-frame"
                                ...
                                width="600" height="450" style="border: 15px" allowfullscreen=""
                                    ...
                                    <li class="single-list">
                                        <div class="d-flex gap-20 mb-20 align-items-center">
                                            ...
                                            <div class="project-info">
                                                ...
                                                <h4 class="project-title"><a href="donation-details.html">18 Best
                                                        Charity Marketing
                                                        Champions</a>
                                                </h4>
                                            </div>
                                    ...
                                    <li class="single-list">
                                        <div class="d-flex gap-20">
                                            ...
                                            <div class="project-info">
                                                ...
                                                <h4 class="project-title"><a href="donation-details.html">Charity
                                                        starts from home. You Can't
                                                        Even
                                                        Help,</a></h4>
                                            </div>
                                        </div>
