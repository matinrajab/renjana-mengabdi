        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body pt-4 p-3">
                    <form action="/admin/slide-banner/update/{{ $banner->id }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="col-md-7">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" placeholder="Title" id="title" required
                                    value="{{ $banner->title }}" name="title" onfocus="focused(this)"
                        ...
                        <div class="col-md-7">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" placeholder="Subtitle" id="subtitle" required
                                    value="{{ $banner->subtitle }}" name="subtitle" onfocus="focused(this)"
                                    onfocusout="defocused(this)">
                            </div>
                        </div>
                        <div class="col-md-7">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" placeholder="Link" id="link" required
                                    value="{{ $banner->link }}" name="link" onfocus="focused(this)"
                                    onfocusout="defocused(this)">
                            </div>
                        </div>
                        <div>
